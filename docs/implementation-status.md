...
51. Spec 56 Phase 56b 已冻结实现边界：Settings drawer 的 dialog/focus scope、Escape/Tab/focus-return 和 settings/guardrail typed catalog；尚未声称完成屏幕阅读器人工验收、完整 catalog 或真实设备 evidence。
