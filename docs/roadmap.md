...
## Spec 52：Capability profiles 与 first-run experience（R1 contract 设计冻结，resolver 待实现）
...
2026-08-05 完成；ADR 0033 已冻结版本化 Capability Profile contract，下一步先实现
contract 测试，再实现纯 resolver，
不改变任何默认权限或 run 创建行为。
