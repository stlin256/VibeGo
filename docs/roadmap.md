...
## Spec 44：Provider/Usage 管理与上游源码复用门禁（44-R0/44-R1/44-R2/R3 已完成）
...
纯内存 pricing catalog 与 BigInt cost projection。退出顺序为：44-R4 resource/audit collectors →
44-R5 认证 API、Web Usage/Audit 和显式导入。任何上游
