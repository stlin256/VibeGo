...
describe('PermissionProfileCard', () => {
  it('keeps workspace coding visibly safe and exposes all bounded posture choices', () => {
    const html = renderToStaticMarkup(<PermissionProfileCard settings={settings} selectedProfileId="workspace-coding" selectedApprovalPosture="bounded-auto" onProfileChange={() => undefined} onApprovalPostureChange={() => undefined} onSave={() => undefined} fullHostAcknowledged={false} onFullHostAcknowledgedChange={() => undefined} />);
